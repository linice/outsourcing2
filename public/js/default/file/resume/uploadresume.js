$(document).ready(function(){
	...
	$(function(){
//		if (usrRoleCode == 'LP') {
//			showLpEmpResumeFileList();
//		} else if (usrRoleCode == 'MEMBER') {
//			showMemberResumeFileList();
//		}
		//法人的员工与普通用户的简历列表一样
		if (usrRoleCode == 'LP' || usrRoleCode == 'MEMBER') {
			showTalentResumeFileList();
		} else if (usrRoleCode == 'ADMIN') {
	...
	$(function() {
		...
		//初始化uploadify简历上传
	    $('#resumeFile').uploadify({
	        swf: '/js/jquery/uploadify/uploadify.swf',
	        uploader: '/file_resume/handleuploadresume',
	        auto: true,
	        fileObjName: 'resumeFile',
	    	height: 30,
	    	width: 120,
	    	buttonText: BROWSE_RESUME_FILE,
	        fileTypeExts: '*.*',
	        formData: {},
			fileSizeLimit: '10MB',
			removeCompleted: false,
			uploadLimit: filesLimit,
...
//      height:'100%'
		columns: [
	            { display: RESUME_NAME, name: 'basename_c', minWidth: 350 },
